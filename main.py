...
def attack(char_name: str, char_class: str) -> str:
    """Возвращает значение урона, нанесенного противнику."""
...
def defence(char_name: str, char_class: str) -> str:
    """Возвращает значение заблокированного урона."""
    if char_class == 'warrior':
...
def special(char_name: str, char_class: str) -> str:
    """Возвращает результат применения специального умения."""
    if char_class == 'warrior':
...
def start_training(char_name: str, char_class: str) -> str:
    """Выводит результат применения функций attack, defence и special."""
    if char_class == 'warrior':
...
def choice_char_class() -> str:
    """Возвращает значение класса персонажа."""
    approve_choice: str = ''
    char_class: str = ''
